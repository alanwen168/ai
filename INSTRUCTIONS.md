...
### 3. Available AI Tools on openclaw

| Tool | Purpose | Command |
|------|---------|---------|
| Codex | Code generation and execution | `codex exec` |
| Claude | Planning, reasoning, and review | `claude -p` |
| Gemini | Alternative analysis and second opinions | `gemini -p` |
